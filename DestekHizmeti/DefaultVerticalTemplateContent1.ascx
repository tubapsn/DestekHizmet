<%@ Control Language="C#" CodeBehind="DefaultVerticalTemplateContent1.ascx.cs" ClassName="DefaultVerticalTemplateContent1" Inherits="ParkBahceler.Web.DefaultVerticalTemplateContent1" %>
                                            ...
                                            <xaf:XafUpdatePanel ID="XafUpdatePanel1" runat="server">
                                                <xaf:ActionContainerHolder runat="server" ID="mainMenu" ContainerStyle="Buttons" Orientation="Horizontal">
                                                    ...
                                                    <actioncontainers> 
                                                        ...
                                                        <xaf:WebActionContainer ContainerId="Save" DefaultActionID="SaveAndClose" IsDropDown="true" AutoChangeDefaultAction="true" />
